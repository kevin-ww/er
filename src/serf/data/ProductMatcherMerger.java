 ...
 * 
 * price - the price of the item being sold title - the title of the item being
 * sold
 * 
 * Note: this class is similar to YahooMatcherMerger. It works with serialized
 * records of a slightly different format.
 * 
 */
public class ProductMatcherMerger extends BasicMatcherMerger implements
  ...
  protected boolean matchInternal(Record r1, Record r2) {
    ...
    ExistentialBooleanComparator equals =
        new ExistentialBooleanComparator(new EqualityMatcher());
