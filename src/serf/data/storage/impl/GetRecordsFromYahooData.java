...
public class GetRecordsFromYahooData extends ParseYahooData implements
    DataSource {
  ...
  public GetRecordsFromYahooData(String[] srcs) throws IOException {
    super(srcs);
    yahooRecords = new HashSet<Record>();
  ...
  @Override
  protected void action(Record r) throws IOException {
    yahooRecords.add(r);
