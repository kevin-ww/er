 ...
 * Records can contain attributies and confidences. Not all SERF algorithms make
 * use of Record confidences.
 * 
 */
public class Record {
  private int _id;
  ...
  private static Map<String, Attribute> setToMap(Set<Attribute> attributeSet) {
    ...
    // Turn the set into a map from "type" (attribute name) to Attribute (name
    // and value)
   ...
   * @return true if two records contain the same confidence value and attribute
   *         set.
   */
  public boolean equals(Object o) {
    ...
    // HashMap.equals() actually makes sure all the values in the map are
    // equal().
