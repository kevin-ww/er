...
public class TitleMatcher implements AtomicMatch {
   ...
   * used to compare string values. Very similar strings will have a jaro score
   * close to 1. Different strings have a jaro score close to 0.
   * 
   * @param s1 title 1
   * @param s2 title 2
   * @return true if jaro.score(title1, title2) > threshold (threshold defaults
   *         to 0.9)
   */
