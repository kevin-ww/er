 ...
 * 
 * stprice - the price of the item being sold spath - a string representing the
 * item's category title - the title of the item being sold
 * 
 */
public class YahooMatcherMerger extends BasicMatcherMerger {
  ...
  protected boolean matchInternal(Record r1, Record r2) {
    ...
    if (sp1 != null && sp2 != null && !equals.attributesMatch(sp1, sp2))
      return false;
